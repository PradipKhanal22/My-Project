<div style="max-width: 600px; margin: 0 auto; font-family: Arial, sans-serif; background-color: #f8f9fa; padding: 20px; border-radius: 10px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1);">
    ...
    <div style="background-color: #fff; padding: 20px; border-radius: 10px; margin-top: 20px;">
        ...
        <p style="font-size: 16px; color: #666; line-height: 1.6;">We are happy to let you know that your Order is now <strong style="color: #2c7bf7;">{{ $status }}</strong>.
        ...
        <p style="font-size: 16px; color: #666; line-height: 1.6;">If you have any questions, feel free to contact our support team at <a href="mailto:support@yatrasathi.com" style="color: #2c7bf7; text-decoration: none;">support@retronepal.com</a>.</p>

        <div style="text-align: center; margin-top: 30px;">
            <a href="{{ route('home') }}" style="background-color: #2c7bf7; color: #fff; padding: 10px 20px; font-size: 16px; border-radius: 5px; text-decoration: none;">Explore More Sportswear</a>
        </div>
    </div>
