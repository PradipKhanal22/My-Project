...
@section('content')
    ...
    <div class="grid grid-cols-5 gap-10 px-24 py-10 border-black">
        ...
        <div class="col-span-1 border shadow-lg rounded-lg px-2 ">
            ...
            <select name="payment_method" class="w-full border rounded-lg p-2 mt-2 bg-green-500 font-bold text-white">
                <option value="COD">Cash On Delivery</option>
            </select>
            <button class="bg-blue-500 text-white p-2 rounded-lg mt-5 pointer hover:bg-gradient-to-r from-red-700 to-yellow-400 hover:text-black font-bold">Checkout</button>
        </div>
    </div>
</form>
